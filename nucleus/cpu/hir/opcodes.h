...
enum OpcodeSignature {
    ...
    OPCODE_SIG_M_F_P   = (OPCODE_SIG_TYPE_M) | (OPCODE_SIG_TYPE_F << 3) | (OPCODE_SIG_TYPE_P << 6),
    ...
    OPCODE_SIG_M_V_F_P = (OPCODE_SIG_TYPE_M) | (OPCODE_SIG_TYPE_V << 3) | (OPCODE_SIG_TYPE_F << 6) | (OPCODE_SIG_TYPE_P << 9),
};
