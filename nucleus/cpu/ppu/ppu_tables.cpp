...
void initTables()
{
    ...
    s_table31[0x03c] = {"td",      PPUInterpreter::td,        dis_td};
    ...
    s_table31[0x33a] = {"sradi1",  PPUInterpreter::sradi1,    dis_unknown};
    s_table31[0x33b] = {"sradi2",  PPUInterpreter::sradi2,    dis_unknown};
