...
public:
    ...
    static void rldic(PPUFields code, PPUThread& thread);
    static void rldicl(PPUFields code, PPUThread& thread);
    static void rldicr(PPUFields code, PPUThread& thread);
    static void rldimi(PPUFields code, PPUThread& thread);
    static void rlwimi(PPUFields code, PPUThread& thread);
    static void rlwinm(PPUFields code, PPUThread& thread);
    static void rlwnm(PPUFields code, PPUThread& thread);
