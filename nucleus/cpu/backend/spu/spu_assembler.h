...
private:
    ...
    void emitFormRI7(U32 instruction, Operand rt, Operand ra, S32 i7);
    void emitFormRI8(U32 instruction, Operand rt, Operand ra, S32 i8);
    void emitFormRI10(U32 instruction, Operand rt, Operand ra, S32 i10);
    void emitFormRI16(U32 instruction, Operand rt, S32 i16);
    void emitFormRI18(U32 instruction, Operand rt, S32 i18);
...
public:
    ...
    void ahi(RegGPR rt, RegGPR ra, S32 i10);
    void ai(RegGPR rt, RegGPR ra, S32 i10);
    void and_(RegGPR rt, RegGPR ra, RegGPR rb);
    void andbi(RegGPR rt, RegGPR ra, S32 i10);
    void andc(RegGPR rt, RegGPR ra, RegGPR rb);
    void andhi(RegGPR rt, RegGPR ra, S32 i10);
    void andi(RegGPR rt, RegGPR ra, S32 i10);
    ...
    void br(S32 i16);
    void bra(S32 i16);
    void brasl(RegGPR rt, S32 i16);
    void brhnz(RegGPR rt, S32 i16);
    void brhz(RegGPR rt, S32 i16);
    void brnz(RegGPR rt, S32 i16);
    void brsl(RegGPR rt, S32 i16);
    void brz(RegGPR rt, S32 i16);
    void cbd(RegGPR rt, RegGPR ra, S32 i7);
    void cbx(RegGPR rt, RegGPR ra, RegGPR rb);
    void cdd(RegGPR rt, RegGPR ra, S32 i7);
    void cdx(RegGPR rt, RegGPR ra, RegGPR rb);
    void ceq(RegGPR rt, RegGPR ra, RegGPR rb);
    void ceqb(RegGPR rt, RegGPR ra, RegGPR rb);
    void ceqbi(RegGPR rt, RegGPR ra, S32 i10);
    void ceqh(RegGPR rt, RegGPR ra, RegGPR rb);
    void ceqhi(RegGPR rt, RegGPR ra, S32 i10);
    void ceqi(RegGPR rt, RegGPR ra, S32 i10);
    void cflts(RegGPR rt, RegGPR ra, S08 i8);
    void cfltu(RegGPR rt, RegGPR ra, S08 i8);
    void cg(RegGPR rt, RegGPR ra, RegGPR rb);
    void cgt(RegGPR rt, RegGPR ra, RegGPR rb);
    void cgtb(RegGPR rt, RegGPR ra, RegGPR rb);
    void cgtbi(RegGPR rt, RegGPR ra, S32 i10);
    void cgth(RegGPR rt, RegGPR ra, RegGPR rb);
    void cgthi(RegGPR rt, RegGPR ra, S32 i10);
    void cgti(RegGPR rt, RegGPR ra, S32 i10);
    void cgx(RegGPR rt, RegGPR ra, RegGPR rb);
    void chd(RegGPR rt, RegGPR ra, S32 i7);
    void chx(RegGPR rt, RegGPR ra, RegGPR rb);
    void clgt(RegGPR rt, RegGPR ra, RegGPR rb);
    void clgtb(RegGPR rt, RegGPR ra, RegGPR rb);
    void clgtbi(RegGPR rt, RegGPR ra, S32 i10);
    void clgth(RegGPR rt, RegGPR ra, RegGPR rb);
    void clgthi(RegGPR rt, RegGPR ra, S32 i10);
    void clgti(RegGPR rt, RegGPR ra, S32 i10);
    void clz(RegGPR rt, RegGPR ra);
    void cntb(RegGPR rt, RegGPR ra);
    void csflt(RegGPR rt, RegGPR ra, S08 i8);
    void cuflt(RegGPR rt, RegGPR ra, S08 i8);
    void cwd(RegGPR rt, RegGPR ra, S32 i7);
    ...
    void dftsv(RegGPR rt, RegGPR ra, S32 i7);
    void dsync();
    ...
    void fsmbi(RegGPR rt, S32 i16);
    void fsmh(RegGPR rt, RegGPR ra);
    void gb(RegGPR rt, RegGPR ra);
    void gbb(RegGPR rt, RegGPR ra);
    void gbh(RegGPR rt, RegGPR ra);
    void hbr(S32 ro, S32 i7);
    void hbra(S32 ro, S32 i16);
    void hbrr(S32 ro, S32 i16);
    void heq(RegGPR rt, RegGPR ra, RegGPR rb);
    void heqi(RegGPR rt, RegGPR ra, S32 i10);
    void hgt(RegGPR rt, RegGPR ra, RegGPR rb);
    void hgti(RegGPR rt, RegGPR ra, S32 i10);
    void hlgt(RegGPR rt, RegGPR ra, RegGPR rb);
    void hlgti(RegGPR rt, RegGPR ra, S32 i10);
    void il(RegGPR rt, S32 i16);
    void ila(RegGPR rt, S32 i18);
    void ilh(RegGPR rt, S32 i16);
    void ilhu(RegGPR rt, S32 i16);
    void iohl(RegGPR rt, S32 i16);
    void iret(RegGPR ra);
    void lnop();
    void lqa(RegGPR rt, S32 i16);
    void lqd(RegGPR rt, RegGPR ra, S32 i10 = 0);
    void lqr(RegGPR rt, S32 i16);
    ...
    void orbi(RegGPR rt, RegGPR ra, S32 i10);
    void orc(RegGPR rt, RegGPR ra, RegGPR rb);
    void orhi(RegGPR rt, RegGPR ra, S32 i10);
    void ori(RegGPR rt, RegGPR ra, S32 i10);
    ...
    void sfhi(RegGPR rt, RegGPR ra, S32 i10);
    void sfi(RegGPR rt, RegGPR ra, S32 i10);
    void sfx(RegGPR rt, RegGPR ra, RegGPR rb);
    void shl(RegGPR rt, RegGPR ra, RegGPR rb);
    void shlh(RegGPR rt, RegGPR ra, RegGPR rb);
    void shlhi(RegGPR rt, RegGPR ra, S32 i7);
    void shli(RegGPR rt, RegGPR ra, S32 i7);
    void shlqbi(RegGPR rt, RegGPR ra, RegGPR rb);
    void shlqbii(RegGPR rt, RegGPR ra, S32 i7);
    void shlqby(RegGPR rt, RegGPR ra, RegGPR rb);
    void shlqbybi(RegGPR rt, RegGPR ra, RegGPR rb);
    void shlqbyi(RegGPR rt, RegGPR ra, S32 i7);
    void shufb(RegGPR rt, RegGPR ra, RegGPR rb, RegGPR rc);
    void stop(); // TODO: ?
    void stopd(); // TODO: ?
    void stqa(RegGPR rt, S32 i16);
    void stqd(RegGPR rt, RegGPR ra, S32 i10 = 0);
    void stqr(RegGPR rt, S32 i16);
    ...
    void xorbi(RegGPR rt, RegGPR ra, S32 i10);
    void xorhi(RegGPR rt, RegGPR ra, S32 i10);
    void xori(RegGPR rt, RegGPR ra, S32 i10);
