...
// SysCalls
S32 sys_ppu_thread_create(BE<U64>* thread_id, sys_ppu_thread_attr_t* entry, U64 arg, U64 unk0, S32 prio, U32 stacksize, U64 flags, U8* threadname);
...
S32 sys_ppu_thread_rename(U64 thread_id, U8* name);
