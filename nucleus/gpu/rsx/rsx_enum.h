...
enum CompareFunc {
    RSX_COMPARE_FUNC_NEVER    = 0x0200,
	RSX_COMPARE_FUNC_LESS     = 0x0201,
	RSX_COMPARE_FUNC_EQUAL    = 0x0202,
	RSX_COMPARE_FUNC_LEQUAL   = 0x0203,
	RSX_COMPARE_FUNC_GREATER  = 0x0204,
	RSX_COMPARE_FUNC_NOTEQUAL = 0x0205,
	RSX_COMPARE_FUNC_GEQUAL   = 0x0206,
	RSX_COMPARE_FUNC_ALWAYS   = 0x0207,
};
